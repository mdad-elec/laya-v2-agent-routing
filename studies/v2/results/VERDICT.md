...
| **H9** Laya-verified cascade (amendment 5) | quality CI lower bound > −0.02 **and** mean-cost CI below 0 against v2-policy | A (zero-shot) AUROC 0.34, B (fine-tuned) 0.46: both escalate nearly everything, 3.7–4× the cost; B-hybrid reduces to v2-policy. Oracle verifier: same quality at ~⅓ the mean cost (`cascade.md`) | **not met** (the ceiling is) |
